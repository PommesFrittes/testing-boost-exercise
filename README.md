[![SSE CI/CD](https://github.com/PommesFrittes/testing-boost-exercise/actions/workflows/boost-testing.yml/badge.svg)](https://github.com/PommesFrittes/testing-boost-exercise/actions/workflows/boost-testing.yml)
